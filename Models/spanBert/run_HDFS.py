...
# 记录日志
filename = "../../OutPut/spanBert/run_HDFS_by10%"
...
class BertClassificationModel(nn.Module):
    def __init__(self):
        ...
        model_class, tokenizer_class, pretrained_weights = (tfs.BertForSequenceClassification, tfs.BertTokenizer, "SpanBERT/spanbert-base-cased")
