...
para = {
    "window_size": 0.5,
    "step_size": 0.2,
    "structured_file": "data/BGL_2k.log_structured.csv",
...
def bgl_sampling(bgl_structured):
    label_data,time_data,event_mapping_data = bgl_structured['Label'].values, bgl_structured['Seconds_since'].values,bgl_structured['EventId'].values
