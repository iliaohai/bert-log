...
# 记录日志
filename = "../../OutPut/ernie/run_HDFS_by10%"
...
class BertClassificationModel(nn.Module):
    def __init__(self):
        ...
        model_class, tokenizer_class, pretrained_weights = (tfs.BertForSequenceClassification, tfs.BertTokenizer, 'nghuyong/ernie-2.0-base-en')
